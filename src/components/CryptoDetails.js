        ...
        "
          ...
          `}
              ...
              <div className="flex w-full mt-4 justify-between">
                ...
                <div className="flex flex-col mx-5">
                  <span className="text-sm capitalize text-gray-100 sm:text-right">
              ...
              <div className="flex w-full mt-4 justify-between">
                <div className="flex flex-col">
                  ...
                  <h2 className="lg:text-base font-bold">
                    {new Intl.NumberFormat("en-IN", {
                      style: "currency",
                      currency: currency,
          ...
          `}
            ...
            <div className="flex flex-col  w-[55%] h-full pl-3">
              ...
              <div className="flex flex-col mt-4 hidden sm:block">
                ...
                <h3 className="text-white py-1 hidden sm:block">
                  <span className="text-gray-100 capitalize mr-1 ">
                    coinGecko rank:{" "}
                  </span>{" "}
                  {data.coingecko_rank}{" "}
            ...
            <div className="absolute bottom-8 right-8 flex items-center hidden sm:flex justify-end">
