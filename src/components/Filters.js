...
const Filters = () => {
  ...
  return (
    <div
      className="lg:w-full h-12 border-2 border-gray-100 rounded-lg
    ...
    >
     ...
     focus:border-cyan leading-4 sm:text-base text-sm
     "
          />
          <button type="submit" className="ml-0 cursor-pointer w-6 h-6 sm:w-auto sm:h-auto">
            <img src={submitIcon} alt="submit" className="w-full h-full" />
          </button>
        </form>

        <label className="relative flex justify-center items-center hidden sm:block">
         ...
         absolute right-1 top-2 pointer-events-none hidden lg:block"
          />
        </label>
        <button
        ...
        >
          <svg
            ...
            height="1em"
            viewBox="0 0 24 24"
            className="w-full h-full fill-cyan hidden sm:block"
            style={{
